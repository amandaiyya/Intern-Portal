  ...
  return (
    <div className='w-screen h-screen bg-gray-950 text-white flex'>
      ...
      <div className='w-full h-full bg-gray-950 py-5 px-5 md:px-10 flex flex-col md:w-1/2 justify-self-end'>
        <h1 className='text-3xl my-7  font-bold'>Login</h1>    
        ...
        <p className='my-5'>Dont have an account? <Link className='underline cursor-pointer text-red-500 hover:no-underline' to={'/signup'}>Sing up</Link></p>
      </div>
    </div>
  )
}
